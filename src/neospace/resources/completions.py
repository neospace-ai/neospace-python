...
class Completions(SyncAPIResource):
    ...
    def create(
        self,
        *,
        model: Union[str, Literal["7b-r16_lora_full_constrained-instruct", "davinci-002", "babbage-002"]],
        ...
        Args:
          ...
          logit_bias: Modify the likelihood of specified tokens appearing in the completion.
              ...
              Accepts a JSON object that maps tokens (specified by their token ID in the NEO
          ...
          suffix: The suffix that comes after a completion of inserted text.
              ...
              This parameter is only supported for `7b-r16_lora_full_constrained-instruct`.
