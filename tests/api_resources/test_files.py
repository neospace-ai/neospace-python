...
from neospace.types import FileObject, FileDeleted
from neospace.pagination import SyncPage, AsyncPage
...
class TestFiles:
    ...
    def test_method_content(self, client: NeoSpace, respx_mock: MockRouter) -> None:
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_content(self, client: NeoSpace, respx_mock: MockRouter) -> None:
        respx_mock.get("/files/string/content").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    def test_streaming_response_content(self, client: NeoSpace, respx_mock: MockRouter) -> None:
        respx_mock.get("/files/string/content").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    def test_path_params_content(self, client: NeoSpace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `file_id` but received ''"):
    ...
    @parametrize
    def test_method_retrieve_content(self, client: NeoSpace) -> None:
    ...
    @parametrize
    def test_raw_response_retrieve_content(self, client: NeoSpace) -> None:
        with pytest.warns(DeprecationWarning):
    ...
    @parametrize
    def test_streaming_response_retrieve_content(self, client: NeoSpace) -> None:
        with pytest.warns(DeprecationWarning):
    ...
    @parametrize
    def test_path_params_retrieve_content(self, client: NeoSpace) -> None:
        with pytest.warns(DeprecationWarning):
            with pytest.raises(ValueError, match=r"Expected a non-empty value for `file_id` but received ''"):
...
class TestAsyncFiles:
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    async def test_method_content(self, async_client: AsyncNeoSpace, respx_mock: MockRouter) -> None:
        respx_mock.get("/files/string/content").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response_content(self, async_client: AsyncNeoSpace, respx_mock: MockRouter) -> None:
        respx_mock.get("/files/string/content").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    async def test_streaming_response_content(self, async_client: AsyncNeoSpace, respx_mock: MockRouter) -> None:
        respx_mock.get("/files/string/content").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    async def test_path_params_content(self, async_client: AsyncNeoSpace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `file_id` but received ''"):
    ...
    @parametrize
    async def test_method_retrieve_content(self, async_client: AsyncNeoSpace) -> None:
        with pytest.warns(DeprecationWarning):
    ...
    @parametrize
    async def test_raw_response_retrieve_content(self, async_client: AsyncNeoSpace) -> None:
        with pytest.warns(DeprecationWarning):
    ...
    @parametrize
    async def test_streaming_response_retrieve_content(self, async_client: AsyncNeoSpace) -> None:
        with pytest.warns(DeprecationWarning):
    ...
    @parametrize
    async def test_path_params_retrieve_content(self, async_client: AsyncNeoSpace) -> None:
        with pytest.warns(DeprecationWarning):
            with pytest.raises(ValueError, match=r"Expected a non-empty value for `file_id` but received ''"):
