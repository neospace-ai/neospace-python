...
class TestJobs:
    ...
    @parametrize
    def test_method_list_events(self, client: NeoSpace) -> None:
    ...
    @parametrize
    def test_method_list_events_with_all_params(self, client: NeoSpace) -> None:
        job = client.fine_tuning.jobs.list_events(
            "ft-AF1WoRqd3aJAHsqc9NY7iL8F",
            after="string",
            limit=0,
    ...
    @parametrize
    def test_raw_response_list_events(self, client: NeoSpace) -> None:
    ...
    @parametrize
    def test_streaming_response_list_events(self, client: NeoSpace) -> None:
    ...
    @parametrize
    def test_path_params_list_events(self, client: NeoSpace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `fine_tuning_job_id` but received ''"):
...
class TestAsyncJobs:
    ...
    @parametrize
    async def test_method_list_events(self, async_client: AsyncNeoSpace) -> None:
    ...
    @parametrize
    async def test_method_list_events_with_all_params(self, async_client: AsyncNeoSpace) -> None:
        job = await async_client.fine_tuning.jobs.list_events(
            "ft-AF1WoRqd3aJAHsqc9NY7iL8F",
            after="string",
            limit=0,
    ...
    @parametrize
    async def test_raw_response_list_events(self, async_client: AsyncNeoSpace) -> None:
    ...
    @parametrize
    async def test_streaming_response_list_events(self, async_client: AsyncNeoSpace) -> None:
    ...
    @parametrize
    async def test_path_params_list_events(self, async_client: AsyncNeoSpace) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `fine_tuning_job_id` but received ''"):
